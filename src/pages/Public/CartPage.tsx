    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">Mi Carrito</h1>
        ...
        {/* Success Message */}
        {success && (
          <div className="mb-6 p-4 sm:p-6 bg-green-50 border border-green-200 rounded-lg flex items-start gap-4">
            <CheckCircle className="h-6 w-6 text-green-600 flex-shrink-0 mt-0.5" />
            <div className="flex-1">
              <p className="text-green-900 font-semibold text-sm sm:text-base">¡Compra realizada exitosamente!</p>
              <p className="text-green-800 text-xs sm:text-sm mt-1">Tu pedido ha sido registrado. Serás redirigido a tu panel en unos momentos...</p>
            </div>
          </div>
        )}
        ...
        {items.length === 0 ? (
          <div className="bg-white rounded-lg border border-gray-200 p-8 sm:p-12 text-center">
            <ShoppingCart className="h-12 sm:h-16 w-12 sm:w-16 text-gray-400 mx-auto mb-4" />
            <p className="text-gray-600 text-base sm:text-lg">Tu carrito está vacío</p>
            <p className="text-gray-500 mt-2 text-sm sm:text-base">Agrega productos para continuar</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
            ...
            <div className="lg:col-span-7">
              <div className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
                <div className="divide-y divide-gray-200">
                  {items.map(item => (
                    <div key={item.id} className="p-4 sm:p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-0 hover:bg-gray-50">
            ...
            <div className="lg:col-span-5">
              <div className="bg-white rounded-xl border border-gray-200 p-6 sm:p-8 shadow-md lg:sticky lg:top-8">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3 mb-5">
                  <div className="w-full sm:flex-1 flex items-center gap-2 border border-gray-300 rounded-lg px-3 py-2.5">
                ...
                <div className="space-y-2 sm:space-y-3 mb-6 pb-6 border-b border-gray-200">
